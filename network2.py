...
import carla
from carlaenvhor2 import CarEnv
...
class QNetwork(nn.Module):
    ...
    def __init__(self, state_size,action_size, seed, fc1_unit=128,
        ...
        self.bn1 = nn.LayerNorm(fc1_unit)
        self.fc2 = nn.Linear(fc1_unit,fc2_unit)
        self.bn2 = nn.LayerNorm(fc2_unit)
...
class Agent():
    ...
    def learn(self, experiences, gamma):
        ...
        writer.add_scalar("loss", loss, len(self.memory))
...
def dqn(n_episodes= 3000, max_t = 1000, eps_start=1.0, eps_end = 0.0001,
       eps_decay=0.996):
    """Deep Q-Learning
    ...
    for i_episode in range(1, n_episodes+1):
        ...
        print('\rEpisode {} score {} eps {}\tAverage Score {:.2f}'.format(i_episode, score, eps, np.mean(scores_window)), end="")
...
scores= dqn()
torch.save(agent.qnetwork_local.state_dict(),'checkpointfinal.pth')
#plot the scores
fig = plt.figure()
